...
const {getConteudos, get10RandomConteudos, getConteudoById, getConteudoByNome,
    getConteudosFilmes, getConteudosSeries, getConteudoGenrosByContId,
...
router.get('/ConteudoGeneros/:contId', getConteudoGenrosByContId);
